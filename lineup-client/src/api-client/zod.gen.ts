...
export const zForm = z.object({
  ...
  questions: z.optional(z.array(zFormQuestion)),
  get schedule() {
...
export const zSchedule = z.object({
  ...
  guid: z.optional(z.uuid()),
  auth0UserId: z.string().max(256),
  name: z.string().max(256),
  dateCoverage: z.array(z.iso.date()),
  startTime: z.iso.time(),
  endTime: z.iso.time(),
  form: z.optional(z.union([z.null(), zForm])),
  formId: z.optional(
    z.union([
      z.null(),
      z
...
export const zScheduleDto = z.object({
  ...
  get shiftAssignments() {
    return z.optional(z.array(z.lazy((): any => zShiftAssignment)));
  },
  schedulePreferences: zSchedulePreferences,
  name: z.string(),
});
...
export const zGetApiAvailabilityByGuidData = z.object({
  body: z.optional(z.never()),
  path: z.object({
    guid: z.uuid(),
  }),
...
export const zGetApiScheduleByGuidCreateAvailabilityData = z.object({
  body: z.optional(z.never()),
  path: z.object({
    guid: z.uuid(),
  }),
